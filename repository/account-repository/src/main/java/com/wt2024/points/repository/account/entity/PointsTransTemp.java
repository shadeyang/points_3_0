...
public class PointsTransTemp {
    ...
    public PointsTransTemp(Long id, String transNo, String customerId, String pointsTypeNo, String institutionId, String transDate, String transTime, String transTypeNo, String debitOrCredit, Date endDate, BigDecimal pointsAmount, String reversedFlag, String oldTransNo, String transChannel, String merchantNo, String voucherTypeNo, String voucherNo, String transStatus, String operator, String sysTransNo, Integer rulesId, String costLine, BigDecimal clearingAmt, String transFlag, Date processDate) {
        this.id = id;
